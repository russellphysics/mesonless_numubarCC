################################################################################
##                                                                            ##
##    CONTAINS: Definitions related to ProtoDUNE-ND geometry.                 ##
...
####---------------- DICTIONARIES USED TO LABEL LOCATIONS ------------------####
...
def tpc_bounds(i):
    ...
    detector_center = [0., -268., 1300.] #[0., 52.25,0.] (MiniRun3)
...
def MINERvA_bounds(i):
    ...
    MINERvA_center = [0., 43.-52.5-268, -654.865+1300.]
